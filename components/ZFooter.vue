    ...
    <footer id="office-footer" :class="{ footer: true, fixed: $route.name == 'download-code' }">
        <div class="footer_pc">
            <div class="footer__pic container">
                <div class="slogan">
                    <div class="anniversary">
                        <span>即构5周年大促</span> <span class="activityTime">即日起-9月30日</span>
                    </div>

                    <span class="free">新注册用户每月20000分钟免费</span>
                </div>

                <a href="https://console.zego.im/account/register" target="_blank" class="apply">立即试用</a>
            </div>
            <div class="footer__container container">
                <div class="footer__introduce">
                    ...
                    <div class="content">
                        <img src="../assets/img/nav/foot/sale-code-new2.png" class="sale-img" alt="sale" />
                        <div class="sale-text">微信扫一扫，与售前工程师直接沟通</div>
                        <!-- <div class="content">
        ...
        <div class="footer_m">
            <section class="pic_img">
                ...
                <h1>新注册用户<br /><span>每月20000分钟免费</span></h1>
                <a href="https://console.zego.im/account/register" class="apply">立即试用</a>
                <!-- <div class="slogan">
                    <div class="anniversary">
                        即构5周年大促
                        <span class="activityTime">即日起-9月30日</span>
                    </div>
                    <span class="free">新注册用户每月20000分钟免费</span>
                </div>
                <a href="https://console.zego.im/account/register" class="apply">立即试用</a> -->
            ...
            <section class="connection container">
                <img src="../assets/img/nav/foot/sale-code-new2.png" alt="sale" class="sale-img" />
                <div class="sale-text">
                    <div
                        v-clipboard:copy="wx"
                    ...
                    <div>
                        <!-- <img src="../assets/img/nav/foot/sale-icon-m.png" alt="sale-icon" class="sale-icon" /> -->
...
.footer {
    ...
    .footer__pic {
        ...
        margin: auto;
        height: 330px;
        background: url(../assets/img/bg/foot2.png);
...
@media screen and (max-width: 1000px) {
    ...
    .footer_m {
        ...
        .pic_img {
            ...
            width: 6.2rem;
            height: 3.2rem;
            // background: url(../../assets/img/nav/activity/mobile/tryNow.png) no-repeat;
            // background: url(../../assets/img/nav/foot_pic_m.png) no-repeat;
            background: url('../assets/img/bg/tryNow.png') no-repeat;
            ...
            /deep/ .activityTime {
                // width: 64px;
                height: 0.38rem;
                background: rgba(208, 221, 255, 1) !important;
                ...
                font-size: 0.2rem;
                font-weight: 500;
                color: rgba(0, 43, 255, 1) !important;
    ...
    .footer_m {
        ...
        //     background: url('../assets/img/nav/foot_pic_m.png');
        //     // background: url('../assets/img/nav/applyNow2.png') no-repeat;
        //     background-size: 100%;
        //     // background-size: 711px 249px;
        //     text-align: right;
        //     h1 {
        //         font-size: 0.4rem;
        //         font-weight: 500;
