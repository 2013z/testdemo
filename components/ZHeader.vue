            ...
            <div class="admin-console clearfix">
                ...
                <div :class="{ 'account-wrapper': true, none: loginStatus === 'logout' }">
                    ...
                    <ul class="account-menu">
                        <li>
                            <a href="https://console.zego.im/profile/userinfo" target="_blank">用户资料</a>
                        </li>
                        <li>
                            <a href="https://console.zego.im/profile/security" target="_blank">账号安全</a>
                        </li>
                        <li>
...
export default class ZHeader extends Vue implements WithRoute {
    ...
    viewUpdatedDetail() {
        ...
        window.location.href = `${this.docUrl}/zh/${idStr}.html`;
